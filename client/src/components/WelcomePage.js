...
const WelcomePage = () => {
  ...
  const redirectUrl = queryParams.get('redirect');  // Get specific query param
console.log(redirectUrl,"redirectUrl");
  useEffect(() => {
    if (redirectUrl) {
      navigate(redirectUrl);  // Redirect if URL param is present
    }
  ...
  return (
    <div className="welcome_main">
      <div className="welcome_maincontainer">
        <div className="welcome_logo">
          <img src="/ADNOC YiS Lockup_NEG.png" alt="Logo" className="welcome_logoone" />
        </div>
        <div className="content_container">
          <div className="content_containerchildone">
            <h1>WELCOME</h1>
